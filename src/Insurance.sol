...
import "./deps/ClaimData.sol";
import "./deps/OptimisticOracleV3Interface.sol";
...
contract Insurance {
    ...
    constructor(address _defaultCurrency, address _optimisticOracleV3, address _reserve) {
    ...
    function issueInsurance(
        ...
        defaultCurrency.safeTransferFrom(reserve, address(this), insuranceAmount);
